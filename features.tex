...
%
\begin{equation}
	\rho^{\mathrm{new}} = \frac{ \rho^{\mathrm{old}} }{ (1 + k \epsilon) }
	\hspace{0.3em},
\end{equation}
%
where $k$ and $\epsilon$ are the scaling and perturbation factors, respectively \citep[see][]{Withers_2013_SCEC, Savran_2014_SSA}.
